...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adjective = JOptionPane.showInputDialog("PLZ enter an adjective");
		...
		String verb = JOptionPane.showInputDialog("Please enter a veeerb!");

		// Get the player to enter a place
		String place = JOptionPane.showInputDialog("NOOOW please enter a place...");
